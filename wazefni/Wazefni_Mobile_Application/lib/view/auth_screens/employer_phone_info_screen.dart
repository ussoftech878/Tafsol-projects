...
import 'package:wazefni_iraq/controllers/EmpolyerPhoneController.dart';
...
class EmployerPhoneInfoScreen extends StatefulWidget {
  static const routeName = 'EmployerPhoneInfoScreen';
  const EmployerPhoneInfoScreen({super.key});

  @override
  State<EmployerPhoneInfoScreen> createState() =>
      _EmployerPhoneInfoScreenState();
}

class _EmployerPhoneInfoScreenState extends State<EmployerPhoneInfoScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset(
            "assets/png/Employer_email_info.png",
            height: 180.w,
            fit: BoxFit.cover,
          ),
          Container(
...
class info extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final EmpolyerPhoneController controller =
        Get.put(EmpolyerPhoneController());
