...
class InstitutionsEmailInfoScreen extends StatefulWidget {
  static const routeName = 'InstitutionsEmailInfoScreen';
  const InstitutionsEmailInfoScreen({super.key});

  @override
  State<InstitutionsEmailInfoScreen> createState() =>
      _InstitutionsEmailInfoScreenState();
}

class _InstitutionsEmailInfoScreenState
    extends State<InstitutionsEmailInfoScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset(
            "assets/png/institutions_info.png",
            height: 180.w,
            fit: BoxFit.cover,
          ),
          Container(
...
class info extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Institutioninfocontroller controller =
        Get.put(Institutioninfocontroller());
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Enter Institution Information'.tr,
              style: TextStyle(
                color: AppColors.blackColor,
                fontSize: 14.sp,
                fontFamily: lang_controller.fontFamily.value,
