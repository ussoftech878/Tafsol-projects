...
import 'package:wazefni_iraq/controllers/OrganizationInfoController.dart';
import 'package:wazefni_iraq/widgets/custom_textfield.dart';
import 'package:wazefni_iraq/widgets/tooltip.dart';

class OrganizationsEmailInfoScreen extends StatefulWidget {
  static const routeName = 'OrganizationsEmailInfoScreen';
  const OrganizationsEmailInfoScreen({super.key});

  @override
  State<OrganizationsEmailInfoScreen> createState() =>
      _OrganizationsEmailInfoScreenState();
}

class _OrganizationsEmailInfoScreenState
    extends State<OrganizationsEmailInfoScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Image.asset(
            "assets/png/organizations_info.png",
            height: 180.w,
            fit: BoxFit.cover,
          ),
          Container(
...
class info extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Organizationinfocontroller controller =
        Get.put(Organizationinfocontroller());
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Enter Organization Information'.tr,
              style: TextStyle(
                color: AppColors.blackColor,
                fontSize: 14.sp,
                fontFamily: lang_controller.fontFamily.value,
