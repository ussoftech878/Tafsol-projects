...
class CorporateSignupScreen extends StatefulWidget {
  static const routeName = 'CorporateSignupScreen';

  const CorporateSignupScreen({super.key});

  @override
  State<CorporateSignupScreen> createState() => _EmployerSignupScreenState();
}

class _EmployerSignupScreenState extends State<CorporateSignupScreen> {
  CorporatesignupscreenController controller =
      Get.put(CorporatesignupscreenController());
