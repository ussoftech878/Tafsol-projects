...
class EmployerEmailInfoScreen extends StatefulWidget {
  static const routeName = 'EmployerEmailInfoScreen';
  const EmployerEmailInfoScreen({super.key});

  @override
  State<EmployerEmailInfoScreen> createState() =>
      _EmployerEmailInfoScreenState();
}

class _EmployerEmailInfoScreenState extends State<EmployerEmailInfoScreen> {
  @override
...
class info extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final EmpolyerEmailController controller =
        Get.put(EmpolyerEmailController());
