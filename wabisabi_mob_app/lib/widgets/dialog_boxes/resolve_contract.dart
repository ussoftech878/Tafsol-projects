...
import 'package:wabisabi_mob_app/widgets/dialog_boxes/resolve_contract2.dart';

void showResolveContractDialogBox(BuildContext context) {
  showDialog(
    context: context,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    textAlign: TextAlign.center,
                    'Are you sure you want to Resolve Contract?',
                    style: GoogleFonts.poppins(
                      textStyle: TextStyle(
                        fontSize: 18.sp,
                    ...
                    children: [
                      Expanded(
                          child: ElevatedButton(
                              onPressed: () {
                                showResolveContract2DialogBox2(context);
                              },
                              child: Text('Yes'))),
                      SizedBox(
                        width: 10.w,
